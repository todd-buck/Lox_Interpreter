...
class ScannerTests {
    //TODO: Verify that klox.Scanner() should be reading last empty token (for EOF)
    @Test
    ...
    fun fileInput_basic_RUN() {
        val path = arrayOf("Testing/InputFiles/basic.txt")
    ...
    fun fileInput_NULL_RUN() {
        val path = arrayOf("Testing/InputFiles/null.txt")
        println("\nNULL TEST FROM FILE (\"\"):")
        main(path)
    ...
    fun fileInput_trimUselessCharacters_RUN() {
        val path = arrayOf("Testing/InputFiles/uselessCharacters.txt")
